...
EFT_PATH = opa.abspath(opa.join(THIS_PATH,'../RedshiftBiasEFT_v2/')) # Expects the EFT code compiled here!!!
...
DEFAULTCONFIG_zbEFT = cfg.ConfigObj({
                ...
                'ComputeBispectrum':'yes',
                 ...
                 'PathToTriangles' : '/Users/jgleyzes/Documents/Projets/EFTofLSS/Python/RedshiftBiasEFT_v2/TrianglesConfiguration',
